...
EVENTS_TO_GERMAN_ALPHANUMERIC = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0", 
    "q", "w", "e", "r", "t", "z", "u", "i", "o", "p", 
    "a", "s", "d", "f", "g", "h", "j", "k", "l", 
    "y", "x", "c", "v", "b", "n", "m"]
...
def printResults(sample_time, detected_events):
    ...
    event_string_german_keyboard = ",".join([EVENTS_TO_GERMAN_ALPHANUMERIC[x] for x in detected_events])
    # print raw event numbers + german key representation
    print("{}".format(event_string_german_keyboard))
