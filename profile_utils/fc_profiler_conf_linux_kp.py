...
# "file": [21,12,34]
FILE_PAGE_BLACKLIST = {
     #"/usr/lib/x86_64-linux-gnu/libX11-xcb.so.1.0.0": [0x1],
     #"/usr/lib/x86_64-linux-gnu/libxcb.so.1.1.0": [0x13, 0x20],  
# 0x1ea2 - 0x14b8: to allow readahead suppression
# 0x1427 - 0x138b: sc_0x29, sc_0xd needed a longer wait time till sampling (therefore excluded)
     #"/opt/google/chrome/chrome": [0x14bb]
} 
...
def prepareEvents():
    ...
    #      0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 
     ...
     #     0x1d, 0x38, 0x39]
    scan_codes = [0x29, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e,
